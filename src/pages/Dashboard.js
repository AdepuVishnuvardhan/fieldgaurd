...
import whereAreYouImage from '../assets/images/wherer u.jpg';
    ...
    <div className="dashboard-container">
      ...
      <div className="dashboard-links">
        ...
        <Link to="/fake-call-timer" className="dashboard-card">
          ...
          <p>Schedule a fake call to make it easier to escape uncomfortable situations.</p>
        </Link>

        {/* Card for Where Are You? */}
        <Link to="/where-are-you" className="dashboard-card">
          <img src={whereAreYouImage} alt="Where Are You?" className="card-img" />
          <h2>Where Are You?</h2>
          <p>Track your real-time location and share it with trusted contacts for safety.</p>
        </Link>
        ...
        <Link to="/track-me" className="dashboard-card">
          ...
          <h2>Track Me</h2>
          <p>Share your location with guardians to be tracked in case of an emergency.</p>
        </Link>

        {/* Card for Friends List */}
        <Link to="/friends-list" className="dashboard-card">
          <img src={friendsListImage} alt="Friends List" className="card-img" />
          <h2>Friends List</h2>
          <p>Connect with your trusted friends to share your location and stay safe together.</p>
        </Link>
        ...
        <Link to="/settings" className="dashboard-card">
          ...
          <h2>Settings</h2>
          <p>Customize your app preferences for alerts, safety features, and privacy settings.</p>
        </Link>
      </div>
    </div>
  );
